...
for model_chosen in model_list:
    ...
    filename = str(model_chosen) + "_" + str(noise_level) + "_severity_detect" +".txt"
    f = open(filename, "w")
    ...
    filename_csv = str(model_chosen) + "_" + str(noise_level) + "_severity_detect" +".csv"
...
# model.save(save_path)
    ...
    save_path = "noise_saved_checkpoints/" + model_chosen + str(noise_level) + "car_damage_severity_model.h5"
    ...
    save_path = str(model_chosen) + "_" + str(noise_level) + "_severity_detection_noise_" + ".jpg"
